...
const ACTION_VERBS: Record<string, string> = {
  ...
  "project.permissions_updated": "updated permissions for",
  "project.status_created": "created status in",
  "project.status_updated": "updated status in",
  "project.statuses_reordered": "reordered statuses in",
  "project.status_deleted": "deleted status from",
  ...
  "project_secret.created": "created",
  "project_secret.updated": "updated",
  "project_secret.rotated": "rotated",
  "project_secret.deleted": "deleted",
