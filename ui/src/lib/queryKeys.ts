export const queryKeys = {
  ...
  projects: {
    ...
    listNav: (companyId: string) => ["projects", companyId, "nav"] as const,
    ...
    principalGrants: (companyId: string, projectId: string) =>
      ["projects", companyId, projectId, "principal-grants"] as const,
  },
  goals: {
    list: (companyId: string) => ["goals", companyId] as const,
    detail: (id: string) => ["goals", "detail", id] as const,
  },
  salesNavigation: (companyId: string) => ["sales-navigation", companyId] as const,
  budgets: {
