    ...
    <div className="space-y-10 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Every component, style, and pattern used across AI-Harness.
        </p>
      </div>
      ...
      <Section title="Status System">
        ...
        <SubSection title="StatusIcon (Jira-style lozenge, interactive)">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-sm">Click the status to open the menu (current: {status})</span>
          </div>
        </SubSection>
      ...
      <Section title="Breadcrumb">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="#">AI-Harness App</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
